...
Run this once after installing the application::
    ...
    python -m papyrussample.scripts.create_db development.ini
"""
...
import papyrussample.models as models

def main():
    if len(sys.argv) != 2:
        sys.exit("Usage: python -m papyrussample.scripts.create_db INI_FILE")
    ini_file = sys.argv[1]
